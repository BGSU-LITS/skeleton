...
class ErrorHandler extends \Slim\Handlers\Error
{
    ...
    protected function renderHtmlErrorMessage(\Exception $exception)
    {
        ...
        // If the exception was generated by our application, use the
        // title and message from that exception for the error.
        if ($exception instanceof \App\Exception\AbstractException) {
            $args['title'] = $exception->title;
            $args['message'] = '<p>' . $exception->message . '</p>';
        }
